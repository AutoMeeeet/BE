...
public class MeetingService {
	...
	public MeetingService(MeetingRepositoryPort meetingRepositoryPort, MeetingParticipantRepositoryPort meetingParticipantRepositoryPort, MeetingReferenceRepositoryPort meetingReferenceRepositoryPort, MinutesRepositoryPort minutesRepositoryPort, RedisUtil redisUtil, RedisUtil redisUtil1) {
	...
	public String createMeeting(Long userId, CreateMeetingDto dto) {
        ...
        redisUtil.saveInviteToken(token, meetingId, duration);
    ...
    public Long joinMeeting(Long userId,String token) {
        ...
        meetingParticipantRepositoryPort.createMeeting(
                meetingId,
                userId,
                true,
                Role.PARTICIPANT,
